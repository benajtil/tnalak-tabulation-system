...
try {
    // Connect to SQLite
    $sqlite = new PDO('sqlite:db/festive.db');
    $sqlite->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    echo "SQLite Connection successful!\n";

    // Connect to MySQL
    $mysql = new PDO('mysql:host=192.168.0.104;dbname=festive', 'root', '');
    ...
    $tables = [
        ...
        'scores' => ['id', 'entry_num', 'judge_name', 'festive_spirit', 'costume_and_props', 'relevance_to_the_theme', 'deduction', 'total_score', 'created', 'updated'],
