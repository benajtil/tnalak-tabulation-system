        ...
        <div class="sidebar">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<a href="Festivededuction.php?entry_num=' . htmlspecialchars($entry_num) . '" class="panel ' . $class . '" data-entry-num="' . htmlspecialchars($entry_num) . '"><strong>Contestant ' . htmlspecialchars($entry_num) . '</strong></a>';
                }
            } else {
