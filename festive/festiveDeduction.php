<?php
include('include/deduction_nav_festive.php');
...
<head>
    ...
    <link rel="stylesheet" href="../festive/css/judgeTableFestive.css">
    <script>
...
<body>
    <div class="container">
        ...
        <h1>DEDUCTION FESTIVE CONTANGENT</h1>
        <form action="submit_festive_deduction.php" method="post" onsubmit="return confirmSubmission()">
