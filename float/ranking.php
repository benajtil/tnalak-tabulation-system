<?php
session_start();
require('../db/db_connection_sqlite.php'); // Ensure this path is correct
...
<body>
    ...
    <div class="overall">
        ...
        <a href="../sync_float.php"><button>Sync Data</button></a>
        ...
        <div class="judge-signatures">
            ...
            foreach ($judges as $judge) : ?>
                <div class="judge-signature" style="font-family:Kanit, sans-serif; text-decoration:none">
                    <a href="/float/indivscores.php?judge=<?php echo htmlspecialchars($judge); ?>" class="no-underline">
